...
async function pushChefTarcilaCollageFullFraming() {
    console.log("🤖 [MoltBot] Iniciando injeção do Poster Colagem Orgânica (Enquadramento Original)...");
    ...
    // Caminho da imagem de colagem com enquadramento corrigido
    const imagePath = "C:\\Users\\Usuario\\.gemini\\antigravity\\brain\\e50213f8-5284-4867-aecc-b4155f86e270\\chef_tarcila_collage_full_framing_1773072512858.png";
    let base64Image = "";
    ...
    try {
        if (fs.existsSync(imagePath)) {
            ...
            console.log(`📸 Imagem Carregada e Convertida: chef_tarcila_collage_full_framing.png`);
        } else {
    ...
    const payload = {
        ...
        images: [
            {
                name: "chef_tarcila_collage_full_framing.png",
                base64: base64Image
            }
        ]
    };
...
pushChefTarcilaCollageFullFraming();
