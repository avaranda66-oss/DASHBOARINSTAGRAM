...
import { Image, Layers, Grid3x3, Heart, MessageCircle, Play, Calendar, Pin } from 'lucide-react';
                                ...
                                >
                                    ...
                                    {post.type !== 'Image' && (
                                        <div className="absolute top-1.5 right-1.5">
                                            {post.type === 'Video' && <Play className="w-4 h-4 text-white drop-shadow-lg fill-white" />}
                                            {post.type === 'Sidecar' && <Layers className="w-4 h-4 text-white drop-shadow-lg" />}
                                        </div>
                                    )}
