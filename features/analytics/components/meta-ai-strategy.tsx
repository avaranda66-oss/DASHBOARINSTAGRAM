...
export function MetaAiStrategy({ posts, summary }: Props) {
    ...
    return (
        <div className="space-y-4">
            {/* Header */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-xl border border-purple-500/20 bg-gradient-to-r from-purple-500/5 to-blue-500/5 p-4">
            ...
            {report && !isLoading && (
                <div className="rounded-xl border border-border bg-card overflow-hidden">
                    <button
                        ...
                        className="flex items-center justify-between w-full px-4 py-3 text-xs font-semibold text-muted-foreground hover:text-foreground transition-colors border-b border-border bg-muted/30"
                    >
            ...
            {!report && !isLoading && !error && (
                <div className="rounded-xl border border-dashed border-purple-500/20 p-8 text-center">
